...
class Settings(BaseSettings):
    ...
    vpn_protocol: str = Field(default="vless", alias="VPN_PROTOCOL")
    vpn_security: str = Field(default="reality", alias="VPN_SECURITY")
    vpn_type: str = Field(default="tcp", alias="VPN_TYPE")
    vpn_sni: str = Field(alias="VPN_SNI")
    vpn_public_key: str = Field(alias="VPN_PUBLIC_KEY")
    vpn_short_id: str = Field(alias="VPN_SHORT_ID")
    vpn_flow: str = Field(default="xtls-rprx-vision", alias="VPN_FLOW")
    vpn_fingerprint: str = Field(default="chrome", alias="VPN_FINGERPRINT")
